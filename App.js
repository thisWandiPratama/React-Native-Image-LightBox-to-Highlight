    ...
    return (
      <ScrollView style={styles.container}>
        <View style={styles.text}>
          <Text>
            React Native Image LightBox to Highlight Image Using Animation In React Native
          </Text>
        </View>
        <Lightbox underlayColor="white">
          <Image
            ...
            resizeMode="contain"
            source={{
              uri: 'https://codersera.com/blog/wp-content/uploads/2019/02/react-native.png',
            }}
          />
        </Lightbox>
      </ScrollView>
...
//       <Header header = 'Header Satu'  />
//       <Header header = 'Header Dua' />
//         <Text style={styles.H1}>MyClass 000 </Text>
//         <Text>{this.state.name}</Text>
//         <TextInput
//           placeholder="Masukan Email Anda"
//           onChangeText= { (tampunganText) => this.setState({name :tampunganText}) }
//           style={{
//             height: 40,
//             borderColor: '#674',
//             borderWidth: 2,
...
//           }}
//         >
//           <Text style={{textAlignVertical: 'center', color: '#909'}}>Tekan Saya</Text>
//         </TouchableOpacity>
